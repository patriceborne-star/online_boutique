...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        String port = props.getOrDefault("DATABASE_PORT", "5433");
        String name = props.getOrDefault("DATABASE_NAME", "my_db41");
        String user = props.getOrDefault("DATABASE_USER", "yugabyte");
